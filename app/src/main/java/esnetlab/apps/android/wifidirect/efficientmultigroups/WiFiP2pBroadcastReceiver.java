...
public class WiFiP2pBroadcastReceiver extends BroadcastReceiver {
    EfficientWiFiP2pGroupsActivity activity;
    WifiP2pManager mManager;
    WifiP2pManager.Channel mChannel;

    public WiFiP2pBroadcastReceiver(WifiP2pManager mManager, WifiP2pManager.Channel mChannel, EfficientWiFiP2pGroupsActivity activity) {
